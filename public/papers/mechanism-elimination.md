...
> `SUBMIT_THESE/papers/PUBLISH_8_MECHANISM_ELIMINATION.md`, which is what the submission PDF was built from and what was
> deposited. **The published version of record is `10.5281/zenodo.21799867`, published 5 August 2026 and resolving at https://doi.org/10.5281/zenodo.21799867**
>
...
>
> **It predates the Tano 2026 integration.** The authoritative local copy adds a section, "What Tano
> 2026 adds to the reconciliation, including one thing it takes away", establishing that physical
> association is necessary for the dimer model and **not sufficient** for the phenotype, and that the
> functional coupling is pharmacologically separable from the dimer through 14-3-3. None of that is
> below. That work also postdates the DOI; see `SUBMIT_THESE/ZENODO_DIVERGENCE_20260806.md`.
>
