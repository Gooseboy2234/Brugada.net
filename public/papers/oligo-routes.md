...
>
> **What this file is.** This project's authoritative copy of the manuscript, `SUBMIT_THESE/papers/PUBLISH_4_OLIGO_ROUTES.md`, which is the file the deposited PDF was built from. Synced 6 August 2026 by `scripts/sync-manuscripts.mjs`, which copies the source byte for byte and prepends this note. Nothing in the manuscript below has been rewritten for the website.
>
