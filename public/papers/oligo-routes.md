...
> `SUBMIT_THESE/papers/PUBLISH_4_OLIGO_ROUTES.md`, which is what the submission PDF was built from and what was
> deposited. **The published version of record is `10.5281/zenodo.21799859`, published 5 August 2026 and resolving at https://doi.org/10.5281/zenodo.21799859**
>
...
> print "34.1".
>
> **This paper diverges in both directions, so neither copy is a safe citation.** The authoritative
> local copy was further edited on 6 August 2026, *after* the 5 August publish, so it is ahead of the
> DOI as well. `SUBMIT_THESE/ZENODO_DIVERGENCE_20260806.md` records the divergence. Cite the DOI for
> the published record and read the local copy for current reasoning.
>
