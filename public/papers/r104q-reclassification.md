...
>
> **What this file is.** This project's authoritative copy of the manuscript, `SUBMIT_THESE/papers/PUBLISH_5_R104Q_RECLASSIFICATION.md`, which is the file the deposited PDF was built from. Synced 7 August 2026 by `scripts/sync-manuscripts.mjs`, which copies the source byte for byte and prepends this note. Nothing in the manuscript below has been rewritten for the website.
>
...
9. Tavtigian SV, Harrison SM, Boucher KM, Biesecker LG. Fitting a naturally scaled point system to the ACMG/AMP variant classification guidelines. Hum Mutat. 2020;41(10):1734-1737. PMID 32720330. DOI 10.1002/humu.24088. *(Resolved 10 August 2026; version 2 of this note carried the author and year only.)*
